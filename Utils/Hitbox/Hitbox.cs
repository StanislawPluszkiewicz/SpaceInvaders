...
namespace SpaceInvaders.Utils.Hitbox
{
    public class Hitbox
    {
        ...
        public Hitbox(IHitbox approximativeHitbox, IHitbox body, IHitbox head = null, params IHitbox[] weapons)
        {
        ...
        public bool MayBeColliding(Hitbox other)
        {
        ...
        public Collision GetCollision(CollisionComponent collisionComponent) // call only after MayBeColliding for performances
        {
            ...
            Hitbox other = collisionComponent.Hitbox;
